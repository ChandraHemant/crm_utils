...
class CRMWrapperOptions extends StatefulWidget {
  /// Constructor of CRMWrapperOptions
  CRMWrapperOptions({
    Key? key,
  ...
  State<StatefulWidget> createState() {
    return _CRMWrapperOptionsState();
  }

  /// define searchable of [CRMSelectBox]
  ...
  /// To get updated size of [CRMSelectBox]
  final GlobalKey<State> containerKey;

  /// define style of [CRMWrapperOption] below of [CRMSelectBox]
  final CRMSelectBoxStyle selectBoxStyle;

  /// define size of [CRMWrapperOption] below of [CRMSelectBox]
  final CRMSelectBoxSize selectBoxSize;

  /// define controller of [CRMWrapperOption] below of [CRMSelectBox]
  final CRMSelectBoxController controller;

  /// define on search action of [CRMWrapperOption] below of [CRMSelectBox]
  final ValueChanged<String>? onSearch;

  /// define on change action of [CRMWrapperOption] below of [CRMSelectBox]
...
class _CRMWrapperOptionsState extends State<CRMWrapperOptions> {
  ...
  void _checkHeight() {
    Future.delayed(Duration(microseconds: CRMSelectBoxConfig.timeDelay), () {

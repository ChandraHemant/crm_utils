...
class BreakPoint {
  ...
  /// Maximum width of [CRMContainer] widget based on [breakpoint]
...
/// If you need to hide some widget in some breakpoint use [CRMVisibility]
...
class CRMVisibility {
  ...
  static const CRMVisibility none = CRMVisibility(breakPoints: []);

  /// Will show in all breakpoint
  static const CRMVisibility block = CRMVisibility(breakPoints: [
    BreakPoint.stateXs,
    BreakPoint.stateSm,
    BreakPoint.stateMd,
    BreakPoint.stateLg,
  ...
  static const CRMVisibility hiddenSm = CRMVisibility(breakPoints: [
    BreakPoint.stateMd,
    BreakPoint.stateLg,
    BreakPoint.stateXl,
    BreakPoint.stateXxl
  ...
  static const CRMVisibility hiddenMd = CRMVisibility(breakPoints: [
    BreakPoint.stateLg,
    BreakPoint.stateXl,
    BreakPoint.stateXxl
  ]);
  ...
  static const CRMVisibility hiddenLg =
      CRMVisibility(breakPoints: [BreakPoint.stateXl, BreakPoint.stateXxl]);

  /// Will hide in ([BreakPoint.stateSm], [BreakPoint.hiddenMd], [BreakPoint.hiddenMd], [BreakPoint.stateXl) breakpoint
  static const CRMVisibility hiddenXl =
      CRMVisibility(breakPoints: [BreakPoint.stateXxl]);

  /// Will only show on [BreakPoint.stateXxl] screen device
  static const CRMVisibility hiddenXxl = CRMVisibility(breakPoints: []);
}
...
class CRMShadow {
  ...
  static const BoxShadow regular =
      BoxShadow(color: Color(0xffd9d9d9), spreadRadius: 8.0, blurRadius: 16.0);

import 'package:crm_utils/src/board_view/crm_board_list.dart';
import 'package:crm_utils/src/board_view/crm_board_view_controller.dart';
import 'package:crm_utils/src/board_view/crm_scrollbar.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'dart:core';


typedef CRMOnDropBottomWidget = void Function(int? listIndex, int? itemIndex,double percentX);
typedef CRMOnDropItem = void Function(int? listIndex, int? itemIndex);
typedef CRMOnDropList = void Function(int? listIndex);

class CRMBoardView extends StatefulWidget {
  final List<CRMBoardList>? lists;
  final double width;
  Widget? middleWidget;
  ...
  CRMBoardViewController? boardViewController;
  int dragDelay;

  Function(bool)? itemInMiddleWidget;
  CRMOnDropBottomWidget? onDropItemInMiddleWidget;
  CRMBoardView({Key? key, this.itemInMiddleWidget,this.scrollbar,this.scrollbarStyle,this.boardViewController,this.dragDelay=300,this.onDropItemInMiddleWidget, this.isSelecting = false, this.lists, this.width = 280, this.middleWidget, this.bottomPadding}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return CRMBoardViewState();
  }
}

class CRMBoardViewState extends State<CRMBoardView> with AutomaticKeepAliveClientMixin {
  Widget? draggedItem;
  ...
  List<CRMBoardListState> listStates = [];

  CRMOnDropItem? onDropItem;
  CRMOnDropList? onDropList;
  ...
  Widget build(BuildContext context) {
    ...
    Widget listWidget = ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        if (widget.lists![index].boardView == null) {
          widget.lists![index] = CRMBoardList(
    ...
    if(widget.scrollbar == true){
      listWidget = CRMScrollbar(
          ...
          style: widget.scrollbarStyle!=null?CRMScrollbarStyle(

...
typedef OnDropItem = void Function(int? listIndex, int? itemIndex,int? oldListIndex,int? oldItemIndex, CRMBoardItemState state);
typedef OnTapItem = void Function(int? listIndex, int? itemIndex, CRMBoardItemState state);
typedef OnStartDragItem = void Function(
    int? listIndex, int? itemIndex, CRMBoardItemState state);
typedef OnDragItem = void Function(int oldListIndex, int oldItemIndex, int newListIndex,
    int newItemIndex, CRMBoardItemState state);

class CRMBoardItem extends StatefulWidget {
  final CRMBoardListState? boardList;
  final Widget? item;
  final int? index;
  ...
  State<StatefulWidget> createState() {
    return CRMBoardItemState();
  }
}

class CRMBoardItemState extends State<CRMBoardItem> with AutomaticKeepAliveClientMixin{
  late double height;
  double? width;

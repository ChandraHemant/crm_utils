import 'package:crm_utils/src/board_view/crm_board_item.dart';
import 'package:crm_utils/src/board_view/crm_board_view.dart';
...
class CRMBoardList extends StatefulWidget {
  final List<Widget>? header;
  final Widget? footer;
  final List<CRMBoardItem>? items;
  final Color? backgroundColor;
  final Color? headerBackgroundColor;
  final CRMBoardViewState? boardView;
  ...
  const CRMBoardList({
    ...
    this.headerBackgroundColor = const Color.fromARGB(255, 255, 255, 255),
    this.boardView,
    this.draggable = true,
  ...
  State<StatefulWidget> createState() {
    return CRMBoardListState();
  }
}

class CRMBoardListState extends State<CRMBoardList> with AutomaticKeepAliveClientMixin{
  List<CRMBoardItemState> itemStates = [];
          ...
          child: ListView.builder(
            ...
            itemBuilder: (ctx, index) {
              if (widget.items![index].boardList == null ||
                ...
                widget.items![index] = CRMBoardItem(
                  boardList: this,
